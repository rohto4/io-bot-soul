...
- 5分ごとの投稿抽選: `POST_DRAW_INTERVAL_SECONDS=300`、`SCHEDULED_POSTING_ENABLED` で制御。
...
主な積み残し:
- 似たような投稿ばかりになる多様性問題（chutes-model-compareで改善）
- AI promptへのキャラクター設定反映の調整
- Docker常駐の実機確認（poll.tick、リプライ、❤同意確認）
